	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/bg_112.png" alt="120">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '50%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Dentista una sonrisa</span>
			            <h1 class="mb-4">Luce tu sonrisa</h1>
			            <p class="mb-4">Nos enorgullecemos de nuestro trabajo de alta calidad y atención al detalle. Con los mejores dentistas.</p>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '30%' }">
		          	<div class="text mt-5">
			            ...
			            <h1 class="mb-4">Agenda tu cita ahora</h1>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/bg-11.jpg);">
						</div>
					</div>
    		</div>
    	</div>
